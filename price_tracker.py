...
Info  : https://brightdata.de/products/insights/price-tracker/drouot
"""
...
# https://brightdata.de/products/web-scraper/drouot
DATASET_ID = os.getenv("BRIGHTDATA_DATASET_ID", "")
if not DATASET_ID:
    raise EnvironmentError(
        "BRIGHTDATA_DATASET_ID is not set.\n"
        "1. Build your Drouot scraper at: https://brightdata.de/products/web-scraper/drouot\n"
